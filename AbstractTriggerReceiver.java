...
abstract public class AbstractTriggerReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        NotificationTmp notification = buildNotification(builder);
     ...
     */
    abstract public void onTrigger (NotificationTmp notification, boolean updated);
     ...
     */
    abstract public NotificationTmp buildNotification (Builder builder);
    ...
    private Boolean isFirstAlarmInFuture (Options options) {
        NotificationTmp notification = new Builder(options).build();
