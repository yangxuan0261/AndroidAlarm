...
public class NotificationTmp {
    ...
    // local file name
    public static final String PUSH_IDS_FILE = "LocalNotificationIds";
    public static final String PUSH_INFO_FILE = "LocalNotificationSet";
     ...
     */
    protected NotificationTmp (Context context, Options options,
    ...
    private void showNotification () {
        ...
        SharedPreferences prefs = context.getSharedPreferences(NotificationTmp.PUSH_INFO_FILE, Context.MODE_PRIVATE);
