...
public class Builder {
    ...
    public NotificationTmp build() {
        ...
        return new NotificationTmp(context, options, builder, triggerReceiver);
    }
    ...
    private void applyContentReceiver(NotificationCompat.Builder builder) {
        ...
        {
        	android.util.Log.i("cocos2dnot", "clickActivity is null");
        	return;
        }
    ...
    private void applyDeleteReceiver(NotificationCompat.Builder builder) {
        ...
        android.util.Log.i("cocos2dnot", "----------- applyDeleteReceiver");
    }
}
